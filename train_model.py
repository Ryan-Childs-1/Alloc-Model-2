...
def main():
    parser = argparse.ArgumentParser(description="Train Allocation AI v2 Keras from historical .xlsb allocation workbooks.")
    ...
    parser.add_argument("--model-dir", default=".", help="Default is current folder to keep the GitHub project flat.")
    ...
    print("Training Keras neural model plus ensemble fallback...")
